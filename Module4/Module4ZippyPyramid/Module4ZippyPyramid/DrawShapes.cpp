...
int main(int argc, char* argv[])
{
    ...
    // Create Pyramid to be rendered, and place it in the map for reference
    {
        UCreateShape("pyramidObject", ShapeMap, pyramidVertices, pyramidIndices, colorShader1.vertShader, colorShader1.fragShader);
    }
...
void URenderShape(Shapes& ShapeMap, GLFWwindow* window) {
    ...
    glm::mat4 projection = glm::perspective(glm::radians(camera.Zoom), (GLfloat)WINDOW_WIDTH / (GLfloat)WINDOW_HEIGHT, 1.0f, 100.0f);
